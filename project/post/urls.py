...
from post.views import post_list, create_post, edit_post, delete_post, post_detail, to_create, create_comment, \
    delete_comment
...
urlpatterns = [
    ...
    path('toCreate/<int:artist_pk>/', to_create, name='to_create'),
